...
class ViewHelper extends Object3D {
	...
	constructor( camera, domElement ) {
		...
		negXAxisHelper.material.opacity = 0;
		negYAxisHelper.material.opacity = 0;
		negZAxisHelper.material.opacity = 0;
		...
		this.render = function ( renderer ) {
			...
			const y = renderer.isWebGPURenderer ? 0 : domElement.offsetHeight - dim;
