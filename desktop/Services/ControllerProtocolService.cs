...
public record struct ControllerPos(double MX, double MY, double MZ, double WX, double WY, double WZ);

public record ControllerInfo(string Firmware, string Board);
public readonly record struct ControllerMachineSettings(
    double StepsPerMmX,
    double StepsPerMmY,
    double StepsPerMmZ,
    double MaxFeedRateX,
...
public sealed class ControllerProtocolService
{
    ...
    public ControllerProtocolService(SerialService serial)
    {
        _serial = serial;
    ...
    public void SendSettingsSet(ControllerMachineSettings settings)
    ...
    private unsafe void ParseResponseFrame(byte[] payload)
    {
        ...
        switch ((ResponseMessageType)payload[0])
        {
            ...
            case ResponseMessageType.Info:
                ...
                InfoReceived?.Invoke(new ControllerInfo(
            ...
            case ResponseMessageType.Pos:
                ...
                PositionChanged?.Invoke(new ControllerPos(pos.Mx, pos.My, pos.Mz, pos.Wx, pos.Wy, pos.Wz));
                break;
            ...
            case ResponseMessageType.MachineSettings:
                ...
                MachineSettingsReceived?.Invoke(new ControllerMachineSettings(
    ...
    private static MachineOperationState MapMachineState(byte state) => (ProtocolMachineState)state switch
    {
        ...
        ProtocolMachineState.Reserved2          => MachineOperationState.CommsFault,
        _                                       => MachineOperationState.CommsFault
    };
