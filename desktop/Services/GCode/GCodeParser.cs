...
public static class GCodeParser
{
    ...
    public static async Task<GCodeDocument> ParseFileAsync(string filePath, CancellationToken cancellationToken)
    {
        ...
        return await ParseAsync(stream, filePath, cancellationToken);
    }

    public static async Task<GCodeDocument> ParseAsync(Stream stream, string sourceName, CancellationToken cancellationToken)
    {
