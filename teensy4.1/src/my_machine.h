...
Notes:
- Teensy 4.1 only for Ethernet and SD
- External magjack required for Ethernet
- EEPROM is optional and must be added

N_AXIS has default value 3 (see grbl/config.h)
*/
...
// ================= PICO UART FRAMEWORK =================
// Pico 2 W is expected to talk to Teensy over Serial1 (pins 0/1 on Teensy 4.1).
...
// Optional future sensor hooks. Leave disabled until those sensors are wired.
...
// ================= INVERSION =================
// VERY IMPORTANT depending on wiring
#define INVERT_X_DIRECTION 0
#define INVERT_Y_DIRECTION 0
#define INVERT_Z_DIRECTION 0

#define INVERT_STEPPERS_ENABLE_PIN 0

// ================= STEP SETTINGS =================
// Match the previously working direct Teensy test as closely as possible.
...
#define DEFAULT_STEPPER_ENABLE_DELAY 300
