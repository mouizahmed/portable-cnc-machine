...
#undef WEBUI_INFLASH
#endif
#if WEBUI_ENABLE && (!defined(LITTLEFS_ENABLE) || LITTLEFS_ENABLE == 0)
...
#define CONTROL_ENABLE (CONTROL_HALT|CONTROL_FEED_HOLD|CONTROL_CYCLE_START)
  ...
  #include "grblhal/boards/cnc_boosterpack_map.h"
#elif defined(BOARD_T40X101)
  #include "grblhal/boards/T40X101_map.h"
#elif defined(BOARD_T41U5XBB)
  #include "grblhal/boards/T41U5XBB_map.h"
#elif defined(BOARD_T41U5XBB_SS)
  #include "grblhal/boards/T41U5XBB_ss_map.h"
#elif defined(BOARD_T41BB5X_PRO)
  #include "grblhal/boards/T41BB5X_Pro_map.h"
#elif defined(BOARD_GRBLHAL2000)
  #include "grblhal/boards/GRBLHAL2000_map.h"
#elif defined(BOARD_E5XMCS_T41)
  #include "grblhal/boards/E5XMCS_T41_map.h"
#elif defined(BOARD_MY_MACHINE)
  #include "grblhal/boards/my_machine_map.h"
#else // default board
#include "grblhal/boards/generic_map.h"
#endif
